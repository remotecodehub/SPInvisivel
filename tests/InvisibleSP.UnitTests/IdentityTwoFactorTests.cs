...
public sealed class IdentityTwoFactorTests
{
    ...
    public async Task Two_factor_should_reject_unknown_user_and_invalid_code()
    {
        ...
        (await fixture.Service.ConfigureTwoFactorAsync("missing", true, "123456", false, false, false, CancellationToken.None))
            .Should().BeNull();
        ...
        (await fixture.Service.ConfigureTwoFactorAsync(user!.Id, true, "123456", false, false, false, CancellationToken.None))
            .Should().BeNull();
    }
    ...
    public async Task Two_factor_should_generate_recovery_codes_when_requested()
    {
        ...
        var result = await fixture.Service.ConfigureTwoFactorAsync(
            user!.Id,
            null,
            null,
            true,
